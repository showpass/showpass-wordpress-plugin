...
5. [Shortcode - [showpass_calendar]](#5-shortcode-showpass_calendar)         
   5.1. [Theme Dark parameter](#52-theme_dark-parameter)                                       
   5.2. [Starting date parameter](#53-starting_date-parameter)   
   5.3. [Tags parameter](#55-tags-parameter)   
   5.4. [Hide schedule parameter](#56-hide_schedule-parameter)   
   5.5. [Recurring events parameter](#57-recurring-events-parameter)   
   5.6. [Show parameter & testing](#58-show-parameter-&-testing)   
   5.7. [Week and month parameters](#59-week-and-month-parameters)
