...
<form method="post" action="options.php">
    ...
    <?php do_settings_sections( 'wpshp-settings-group' ); ?>
        ...
        <small>Disable to fix Local SSL Expired issue on servers running an older operating system</small><br/><br/>
...
<p>For full documentation please visit <a href="https://github.com/showpass/showpass-wordpress-plugin" target="_blank">https://github.com/showpass/showpass-wordpress-plugin</a></p>

<p>For futher installation instructions please visit <a href="https://help.showpass.com/hc/en-us/articles/360023833073-Installing-the-Showpass-wordpress-extension" target="_blank">this support article.</a></p>

<p>To register for an Organizer Showpass account to start selling tickets <a href="https://www.showpass.com/organizations/register/" target="_blank">click here</a></p>
