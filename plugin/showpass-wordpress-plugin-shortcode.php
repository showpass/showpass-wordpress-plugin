...
function showpass_scripts(){
	if (!is_admin()) {
		...
		wp_register_script('showpass-calendar-script', plugins_url( '/js/showpass-calendar.js', __FILE__ ), array('jquery'), '3.7.2', true);
		...
		wp_enqueue_script('showpass-custom', plugins_url( '/js/showpass-custom.js', __FILE__ ), array('jquery'), '3.7.2', true);
	}
}
