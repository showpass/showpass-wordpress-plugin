...
$(window).ready(function() {
		...
		function renderDailyCalendar(date) {
				...
				if (venue) {
						// set initial URL
			var url = "http://local.showpass.com:8000/api/public/events/?venue__in=" + venue + "&page_size=100&starts_on__gte=" + dayStart + "&starts_on__lt=" + dayEnd;
		...
		function renderCalendarWeek(week) {
				...
				if (venue) {
						// set initial URL
			var url = "http://local.showpass.com:8000/api/public/events/?venue__in=" + venue + "&page_size=100&starts_on__gte=" + startWeek;
						// if tags param append to url
						if (tags) {
								url = url + "&tags=" + tags;
						}
		...
		function renderCalendar(year, month) {
			...
			var url = "http://local.showpass.com:8000/api/public/events/?venue__in=" + venue + "&page_size=100&starts_on__gte=" + startMonth;
